...
var ASM_CONSTS = {
  100718: () => { if (document.fullscreenElement) return 1; },  
 100764: () => { return Module.canvas.width; },  
 100796: () => { return parseInt(Module.canvas.style.width); },  
 100844: () => { document.exitFullscreen(); },  
 100871: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 100943: () => { if (document.fullscreenElement) return 1; },  
 100989: () => { return Module.canvas.width; },  
 101021: () => { return screen.width; },  
 101046: () => { document.exitFullscreen(); },  
 101073: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 101267: () => { return window.innerWidth; },  
 101293: () => { return window.innerHeight; },  
 101320: () => { if (document.fullscreenElement) return 1; },  
 101366: () => { return Module.canvas.width; },  
 101398: () => { return parseInt(Module.canvas.style.width); },  
 101446: () => { if (document.fullscreenElement) return 1; },  
 101492: () => { return Module.canvas.width; },  
 101524: () => { return screen.width; },  
 101549: () => { return window.innerWidth; },  
 101575: () => { return window.innerHeight; },  
 101602: () => { if (document.fullscreenElement) return 1; },  
 101648: () => { return Module.canvas.width; },  
 101680: () => { return screen.width; },  
 101705: () => { document.exitFullscreen(); },  
 101732: () => { if (document.fullscreenElement) return 1; },  
 101778: () => { return Module.canvas.width; },  
 101810: () => { return parseInt(Module.canvas.style.width); },  
 101858: () => { document.exitFullscreen(); },  
 101885: ($0) => { Module.canvas.style.opacity = $0; },  
 101923: () => { return screen.width; },  
 101948: () => { return screen.height; },  
 101974: () => { return window.screenX; },  
 102001: () => { return window.screenY; },  
 102028: () => { return window.devicePixelRatio; },  
 102064: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102117: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 102168: () => { Module.canvas.style.cursor = 'none'; },  
 102205: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102461: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 102512: () => { if (document.pointerLockElement) return 1; },  
 102559: () => { if (document.fullscreenElement) return 1; },  
 102605: () => { return window.innerWidth; },  
 102631: () => { return window.innerHeight; }
};
